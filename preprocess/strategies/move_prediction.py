...
def move_ranking(all_inputs):
    ...
    legal_move_sample_weights = tf.ones_like(legal_move_scores, dtype=tf.float32)
    ...
    move_sample_weights = tf.tensor_scatter_nd_update(move_sample_weights, legal_moves_idx, legal_move_sample_weights)
