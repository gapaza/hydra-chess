...
from preprocess.strategies.old.window_pt_small import preprocess_linear, preprocess_batch

from preprocess.generators.FT_DatasetGenerator import FT_DatasetGenerator
...
def test_concat_dataset():
    ...
    dataset_2 = tf.data.TextLineDataset(
        '/Users/gapaza/repos/gabe/hydra_old-chess/datasets/pt/millionsbase/chunks_uci/pgn_chunk_2_100000.txt')
...
import tqdm
def game_result():
    game_file = '/Users/gapaza/repos/gabe/hydra_old-chess/datasets/pt/millionsbase/chunks_pgn/chunk_0_100k.pgn'
    ccom_game_file = '/Users/gapaza/repos/gabe/hydra_old-chess/datasets/pt/chesscom/chunks_pgn/chunk_2_100k.pgn'
    ccom_dir = '/Users/gapaza/repos/gabe/hydra_old-chess/datasets/pt/chesscom/chunks_pgn'
