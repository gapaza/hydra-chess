...
from hydra.alibi_decoder.AlibiBias import AlibiBias
...
@keras.saving.register_keras_serializable(package="AlibiMultiHeadAttention", name="AlibiMultiHeadAttention")
class AlibiMultiHeadAttention(keras.layers.Layer):
    def __init__(
            self,
            num_heads,
            key_dim,
    ...
    def from_config(cls, config):
        ...
        if None in [query_shape, key_shape, value_shape]:
            print("One of dimensions of the input shape is missing. It ",
    ...
    def _compute_attention(
        ...
        attention_scores = self.alibi_bias(attention_scores)
